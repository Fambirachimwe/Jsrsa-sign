(function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require == "function" && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
    1: [function (require, module, exports) {
        ...
        self.addEventListener('fetch', function (event) {
            ...
            // console.log(event.request) this is just a simple request 
            ...
            event.respondWith(
                ...
                fetch(new Request(event.request, { mode: mode, credentials: credentials }))  // new fetch 
        ...
        function createResponseObject(response) {
            ...
            // Here read the data that has been sent by the server 

            // console.log(response); //this is the response object with the body readable stream
            ...
            var result = {
                ...
                // data: 'data placeholder here'  //  put the read data here if it is a json oject -- else 
            };
            ...
            if(headers.length > 0){
                const contentType = headers.filter(header => header.name === 'content-type')[0]
                if(contentType.value !== "application/javascript; charset=UTF-8"){
                    const reader = response.clone().body.getReader();

                    let mydata;
                    reader.read()
                    .then(({done, value}) => {
                        mydata = JSON.parse(new TextDecoder().decode(value));
                        // console.log(mydata)
                        result.data = mydata
                    });

                } else {
                    // read the html or javascript to a string
                    ...
                    reader.read()
                    .then(({done, value}) => {
                        mydata = new TextDecoder().decode(value);
                        // console.log(mydata)
                        result.data = {data: mydata}
                    });
                    // console.log(response)
                    // result.data = {data: 'sign the data of the static files' }
                }
